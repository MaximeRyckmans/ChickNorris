...
<body>
	...
	<div id="content">
		...
		<div id="formula-wrapper">
			...
			<div class="formula-extra col-md-6">
				<h3>Geen zin in de afwas? Maak het u dan nog gemakkelijker met &eacute;&eacute;n van de volgende formules:</h3>
			</div>
			<div class="panel panel-default col-xs-12 col-md-3">
				<div class="panel-heading">
		...
		<div id="formula-extrainfo" class="col-xs-12">
			...
			<div id="fine-print">
				<ul>
					...
					<li>(**) - Hierin is inbegrepen; Huur van de wagen, Verplaatsingsvergoeding, personeelskosten, aansprakelijkheidsverzekering met een maximum bedrag van het geen de verzekeringspolis dekt.</li>
					<li>(***) - Optie springkasteel voor 75 EUR per dag.</li>
				</ul>
			</div>
		</div>
	</div>
